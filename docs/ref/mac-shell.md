...
|${\#arr[*]|长度||
|${\#arr[@]|长度||
||\$ a=(1 2 3 4 5) <br>\$ echo ${a[*]} <br> > 1 2 3 4 5 <br> \$ echo \${#a[*]} <br> > 5 <br> \$ echo \${a[2]} <br> > 3 <br> \$ echo \${a[@]:2:4} <br> > 3 4 5	<br> $ echo ${a[@]: -2} <br> > 4 5 <br> \$ echo \${a[@]: 2} <br> > 3 4 5 <br> \$ unset a[3] <br>\$ echo \${a[@]} <br>> 1 2 3 5||
